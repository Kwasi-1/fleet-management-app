  ...
  const items: MenuItem[] =
    {
      "": [
        ...
        },
        {
          ...
          link: "/fleet",
          parent: ["fleet", false] as [string, boolean],
          permitted_roles: [],
          sublinks: [
            {
              title: "Overview",
        ...
        },
        {
          ...
          parent: ["order_Management", false] as [string, boolean],
          permitted_roles: [],
          sublinks: [],
        },
        {
          ...
          link: "/logistics",
          parent: ["logistics", false] as [string, boolean],
          permitted_roles: [],
          sublinks: [],
        },
        {
          ...
          link: "/invoices",
          parent: ["invoices", false] as [string, boolean],
          permitted_roles: [],
          sublinks: [],
        },
      ],
